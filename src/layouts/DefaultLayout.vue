  ...
  <Modal :show="modals.login" @close-modal="closeModal">
    ...
    <form>
      <div class="mb-4">
        ...
        <div class="form__field relative">
          <input class="input__field" v-model="formLogin.email" type="text" placeholder="bruce.wayne@imnotbatman.org" />
        </div>
      </div>
      <div class="mb-4">
        <label class="input__label">Password</label>
        <div class="form__field relative">
          <input class="input__field"  v-model="formLogin.password" type="password" placeholder="*****" />
        </div>
      </div>
       <div class="mb-4">
